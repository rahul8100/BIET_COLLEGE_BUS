...
void text2d()
{
   ...
   int k;
   glColor3f(0.0,0.0,0.0);
   glRasterPos3f(280,400,70);
   for(k=0;k<strlen(string2);k++)
   glutBitmapCharacter(font2,string2[k]);

   char string3[]="institue of";
   void *font3=GLUT_BITMAP_TIMES_ROMAN_24;

   glColor3f(0.0,0.0,0.0);
   glRasterPos3f(260,380,70);
   for(k=0;k<strlen(string3);k++)
   glutBitmapCharacter(font3,string3[k]);

   char string4[]="technology";
   void *font4=GLUT_BITMAP_TIMES_ROMAN_24;
   ...
   char string5[]="Davangere";
   void *font5=GLUT_BITMAP_TIMES_ROMAN_24;

   glColor3f(0.0,0.0,0.0);
   glRasterPos3f(260,340,70);
   for(k=0;k<strlen(string5);k++)
   glutBitmapCharacter(font5,string5[k]);
...
char string[]="BAPUJI INSTITUTE OF ENGINEERING AND TECHNOLOGY,Davangere";
char string0[]="Department Of Computer Science And Engineering";
void *font=GLUT_BITMAP_TIMES_ROMAN_24;
int k;
glColor3f(0.0,0.0,0.0);
glRasterPos3f(200,600,70);
for(k=0;k<strlen(string);k++)
        glutBitmapCharacter(font,string[k]);


char string1[]="Topic:BIET COLLEGE BUS";
void *font1=GLUT_BITMAP_TIMES_ROMAN_24;
glColor3f(0.0,0.0,0.0);


glRasterPos3f(400,430,0);
...
char string3[]="RAHUL M --> 4BD19CS067";
...
char string4[]="SANDESH V C --> 4BD19CS077";
...
char string8[]="Click The Left Mouse Button To Start";
